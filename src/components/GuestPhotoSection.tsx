...
export const GuestPhotoSection: React.FC = () => {
  ...
  return (
    <div className="text-center animate-fade-in-up">
      ...
      {/* 강조 카드 */}
      <div className="bg-gradient-to-b from-[#e8f4fd] to-[#f0f8ff] rounded-2xl p-8 border border-[#2b5797]/20 shadow-lg shadow-[#5da2d5]/10">
        <div className="w-16 h-16 rounded-full bg-[#2b5797]/10 flex items-center justify-center mx-auto mb-5">
          <CameraIcon size={28} className="text-[#2b5797]" strokeWidth={1.5} />
        </div>

        <p className="text-2xl tracking-[0.15em] text-[#1a1a1a] font-medium mb-2">
          우리의 스냅 작가가
        </p>
        <p className="text-2xl tracking-[0.15em] text-[#2b5797] font-medium mb-5">
          되어주세요!
        </p>
        ...
        {/* 스타벅스 이벤트 안내 */}
        <div className="bg-white/80 rounded-xl px-5 py-4 mb-8 border border-[#2b5797]/15">
          <p className="text-base text-[#1a1a1a] font-medium mb-1">
            제일 정성스럽게 예쁘게 찍어주신 분께
          </p>
          <p className="text-lg text-[#2b5797] font-bold tracking-wide">
            스타벅스 기프티콘 3만원을 쏩니다!
          </p>
        </div>
        ...
        <div className="relative mb-6">
          <User size={16} className="absolute left-4 top-1/2 -translate-y-1/2 text-[#8faabe]" />
          <input
            type="text"
            value={uploaderName}
            onChange={(e) => setUploaderName(e.target.value)}
            placeholder="성함을 입력해주세요"
            className="w-full pl-10 pr-4 py-3 bg-white border border-[#8faabe]/20 rounded-lg text-base text-[#1a1a1a] placeholder-[#9fb5c8] focus:outline-none focus:border-[#2b5797]/40 transition-colors font-[inherit]"
          />
        </div>
        ...
        {uploading ? (
          <div className="flex flex-col items-center gap-3">
            <Loader2 size={24} className="text-[#2b5797] animate-spin" />
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            <p className="text-base text-[#1a1a1a] mb-4">
