  ...
  return (
    <div className="text-center animate-fade-in-up">
      ...
      <div className="bg-gradient-to-b from-[#e8f4fd] to-[#f0f8ff] rounded-2xl p-8 border border-[#5da2d5]/20 shadow-lg shadow-[#5da2d5]/10">
        ...
        <p className="text-2xl tracking-[0.15em] text-[#2c3e50] font-medium mb-2">
          우리의 스냅 작가가
        </p>
        <p className="text-2xl tracking-[0.15em] text-[#5da2d5] font-medium mb-5">
          되어주세요!
        </p>

        <p className="text-base text-[#3d5568] leading-relaxed mb-4">
          결혼식 당일 찍어주신 사진을<br />
          공유해 주시면 소중히 간직하겠습니다
        </p>
        ...
        <div className="bg-white/80 rounded-xl px-5 py-4 mb-8 border border-[#5da2d5]/15">
          <p className="text-base text-[#2c3e50] font-medium mb-1">
            제일 정성스럽게 예쁘게 찍어주신 분께
          </p>
          <p className="text-lg text-[#5da2d5] font-bold tracking-wide">
            스타벅스 기프티콘 3만원을 쏩니다!
          </p>
        </div>
        ...
        <div className="relative mb-6">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-3 bg-white border border-[#a5c8e4]/20 rounded-lg text-base text-[#3d5568] placeholder-[#8fb8d4] focus:outline-none focus:border-[#5da2d5]/40 transition-colors font-[inherit]"
          />
        </div>
        ...
        {uploading ? (
          <div className="flex flex-col items-center gap-3">
            ...
            <p className="text-base text-[#3d5568]">
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            <p className="text-base text-[#3d5568] mb-4">
