  ...
  return (
    <div className="text-center animate-fade-in-up">
      ...
      <div className="grid grid-cols-2 gap-4">
        {/* 신랑 */}
        <div>
          <p className="text-[10px] text-[#5da2d5] tracking-wider mb-3">
          ...
          <p className="text-[11px] text-[#3d5f78] font-light mb-1.5">
            2000년생, 사랑에 몰입하는
          </p>
          <p className="text-[11px] text-[#3d5f78] font-light mb-2">
            함께 성장하고 싶은 <span className="text-[#5da2d5] font-medium">ENTJ</span>
          </p>

          <div className="flex flex-wrap justify-center gap-1 mb-3">
            <span className="text-[10px] text-[#6a9bc0]">#운동러버</span>
            <span className="text-[10px] text-[#6a9bc0]">#기술자</span>
          </div>

          <p className="text-[11px] text-[#3d5568] font-light leading-relaxed">
        ...
        {/* 신부 */}
        <div>
          <p className="text-[10px] text-[#e8a0b4] tracking-wider mb-3">
          ...
          <div className="flex flex-wrap justify-center gap-1 mb-3">
            <span className="text-[10px] text-[#6a9bc0]">#똑순이</span>
            <span className="text-[10px] text-[#6a9bc0]">#디지털노마드가되고싶은</span>
            <span className="text-[10px] text-[#6a9bc0]">#현재는그냥노마드</span>
          </div>
