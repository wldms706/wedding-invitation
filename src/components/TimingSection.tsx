...
export const TimingSection: React.FC = () => {
  return (
    <div className="text-center animate-fade-in-up">
      ...
      <div className="space-y-2 text-base text-[#3d5f78] font-light leading-relaxed">
        <p>2026년 4월 19일 일요일</p>
        <p>오후 2시 20분</p>
        <p className="pt-2 text-sm text-[#6a9bc0]">
          식전 30분부터 입장 가능합니다
        </p>
      </div>

      <div className="mt-8 mx-auto max-w-[200px] border border-[#a5c8e4]/20 rounded-lg p-4">
        <div className="text-sm text-[#6a9bc0] tracking-wider mb-2">식순</div>
        <div className="space-y-2 text-[15px] text-[#3d5f78] font-light">
          <p>개식사</p>
          <p>신랑 · 신부 입장</p>
          <p>혼인 서약</p>
          <p>성혼 선언</p>
