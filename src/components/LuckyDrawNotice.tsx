  ...
  return (
    <div className="text-center animate-fade-in-up">
      ...
      <div className="bg-white/60 rounded-lg p-6 border border-[#a5c8e4]/10">
        <p className="text-base text-[#3d5f78] font-light leading-relaxed mb-4">
          축가가 끝난 후 럭키드로우 이벤트가 진행됩니다!
        </p>
        <div className="bg-[#f0f8ff] rounded-lg p-4 border border-[#a5c8e4]/20">
          <p className="text-base text-[#2c3e50] font-medium tracking-wide">
            🎫 식권을 꼭 보관해 주세요
          </p>
          <p className="text-sm text-[#3d5f78] font-light mt-2 leading-relaxed">
            식권 번호로 추첨이 진행되오니<br />
