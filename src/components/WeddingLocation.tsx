  ...
  return (
    <div className="text-center animate-fade-in-up">
      ...
      <div className="flex justify-center mb-6">
        <MapPin size={20} className="text-[#8faabe]" strokeWidth={1} />
      </div>

      <p className="text-xl tracking-[0.2em] text-[#1a1a1a] font-light mb-2">
        오시는 길
      </p>

      <p className="text-base text-[#1a1a1a] font-light mb-1">
        {couple.weddingLocation}
      </p>
      <p className="text-sm text-[#7a9cbc] font-light mb-6">
        {address}
      </p>

      {/* Map */}
      <div className="w-full rounded-lg overflow-hidden mb-6 border border-[#8faabe]/20">
        <div
          ref={mapRef}
      ...
      <div className="flex justify-center gap-3 mb-8">
        <a
          ...
          className="flex items-center gap-1.5 px-4 py-2.5 rounded-full border border-[#8faabe]/30 text-sm text-[#1a1a1a] tracking-wider hover:bg-[#f0f8ff] transition-colors"
        >
          <Navigation size={12} />
          카카오맵
        </a>
      ...
      {/* Transportation info */}
      <div className="text-left space-y-6 bg-white/60 rounded-lg p-6 border border-[#8faabe]/10">
        {/* 평택역에서 */}
        <div>
          <p className="text-base text-[#2b5797] tracking-wider mb-2.5 font-medium flex items-center gap-2">
            <span>🚉</span> 평택역에서
          </p>
          ...
          <p className="text-sm text-[#7a9cbc] font-light mt-2 leading-relaxed">
            🚌 1000, 1199, 1311, 1361/1371, 1452,<br />
            15, 20, 80, 810, 98, 777,<br />
            마을버스 10, 5, 55
          </p>
          <p className="text-sm text-[#7a9cbc] font-light mt-1.5">
            택시 이용 시 약 5분
          </p>
        </div>
